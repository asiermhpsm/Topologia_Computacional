...
clases hijas, en las que se puede añadir más metodos y atributos e incluso hacer algún añadido a los métodos
...
0,1,2,3... y que tendrá todo un peso 0 (aunque se pueda cambiar manualmente). Por otro lado las clases hijas
guardarán además las coordenadas de los puntos y en su contructor calculará los pesos de los simplices.
...
en la que se accede atributo 'points' (las coordenadas de los puntos, que no existe en la clase padre pero sí en las hijas) 
y si dá una excepción (es decir 'points' no existe y por lo tanto estoy en una instancia de la clase padre) se 
...
tan alejados que no se podian apreciar lso resultados. Por lo tanto, una vez calculado todo, se limitan los ejemplos
...
medida que el peso aumenta y una función analiza() que, en una misma pestala representa los puntos, la animcaión del
